 ...
 */
export function startHand(config, seats, deck) {
    ...
    const players = seats.map((seat) => {
        const cards = [currentDeck[0], currentDeck[1]];
 ...
 */
function handlePostAction(state) {
